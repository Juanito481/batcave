/** Event types emitted by the activity monitor to the webview. */
...
export interface ToolEvent {
  ...
  toolName: string;
  /** Slash command name if this tool call is a Skill invocation. */
  skillName?: string;
  timestamp: number;
}
...
export interface BatCaveConfig {
  /** Active workspace folder name (repo). */
  activeRepo: string;
  /** Map of agent slash-command names to display metadata. */
